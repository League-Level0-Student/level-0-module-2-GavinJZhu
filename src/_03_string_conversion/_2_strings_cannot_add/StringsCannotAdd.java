...
public class StringsCannotAdd {
	...
	public static void main(String[] args) {
		...
		String fourAsString = JOptionPane.showInputDialog(null, "Enter in the number 4.");
		// 3) Ask the user to enter number 6 and hold it in the variable sixAsString
		String sixAsString = JOptionPane.showInputDialog(null, "Enter in the number 6.");
		...
		String fiveAsString = JOptionPane.showInputDialog(null, "Enter in the number 5.");
		// 6) Print the addition of the variables fourAsString, sixAsString, and
		// fiveAsString

		// Did you notice 456 instead of 4 + 6 + 5 = 15?

		// Insert fourAsString inside the parenthesis of Integer.parseInt() and set the
		// method equal to fourAsInt
		...
		// Did you notice the value 10? If so, hurray! You just changed the type of your
		// variable from String to int.

		// 9) Convert fiveAsString to fiveAsInt using Integer.parseInt();
		int fiveAsInt = Integer.parseInt(fiveAsString);
		// 10) Print the addition of fourAsInt, sixAsInt, and fiveAsInt using
		// JOptionPane
